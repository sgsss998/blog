...
description: "老明按： 这是 只写给 macOS 的一篇，写法上会 稍微啰嗦一点 ：不全是为凑字数，而是把「这一步到底在干什么、不装会怎样、和前后几步什么关系」说清楚。你要是熟手，目录跳着看就行；要是第一次碰终端，跟着走不容易心里发虚。 落地目标就四件事： 会开终端 → 依赖齐活（Git、Node） → Claude Code 装好 → 接上智谱 GLM （账单与 Key 在国内平台，不必绑 Claude 官网那一套订阅）。 智谱侧以 Claude…"
pubDate: 2026-04-10
keywords: ["Claude Code", "智谱", "GLM", "Mac", "终端", "Git", "Node", "教程"]
heroImage: "/images/blog/claude-code-mac-glm-2026-wechat-01.png"
---
...
智谱侧以 Claude API 兼容 与 Coding Plan 快速开始 为准；CC 本体以 Advanced setup 为准。
...
![](/images/blog/claude-code-mac-glm-2026-wechat-01.png)（上面那个符号是“command”，在空格的左边）打开终端提示
...
![](/images/blog/claude-code-mac-glm-2026-wechat-02.png)  
pwd 与 git 版本

* * *

### 1.2 安装Git：不是「只有程序员才要」，CC 也吃它
...
![](/images/blog/claude-code-mac-glm-2026-wechat-03.png)Git 官网 · macOS 安装说明
...
**如果你机器上还没有 Homebrew** ：先到 brew.sh 按官方一条命令装好（装一次管很久）。**如果你打死不用 Homebrew** ：Git 可走官网 / Xcode CLI；Node 可走 nodejs.org 安装包；Claude Code 可走官方的 **`curl … install.sh`** ——也就是本篇后面的「原生安装」，不依赖 brew。
...
![](/images/blog/claude-code-mac-glm-2026-wechat-04.png)  
Node.js 官网下载区  


装好后在终端确认：

![](/images/blog/claude-code-mac-glm-2026-wechat-05.png)node 与 npm 版本
...
![](/images/blog/claude-code-mac-glm-2026-wechat-06.png)  
Claude Code 官方 Advanced setup 节选

### 2.1 推荐：原生一条命令（官方主推，不依赖 npm）

  
![](/images/blog/claude-code-mac-glm-2026-wechat-07.png)  
原生安装命令
...
![](/images/blog/claude-code-mac-glm-2026-wechat-08.png)  
brew install cask
...
![](/images/blog/claude-code-mac-glm-2026-wechat-09.png)  
npm 全局安装（Deprecated）
...
![](/images/blog/claude-code-mac-glm-2026-wechat-10.png)  
claude --version

  * **`claude --version`** ：确认二进制已进 PATH，版本号能打印出来。

  
![](/images/blog/claude-code-mac-glm-2026-wechat-11.png)  
claude doctor 说明
...
![](/images/blog/claude-code-mac-glm-2026-wechat-12.png)![](/images/blog/claude-code-mac-glm-2026-wechat-13.png)智谱 · Claude API 兼容文档  
智谱 · GLM Coding Plan 快速开始  
...
### 变量输完之后，再在终端新开一行回车，输入“claude”，并回车，就能成功使用 claude 了。
...
![](/images/blog/claude-code-mac-glm-2026-wechat-15.png)  
zshrc 提示
...
本稿教学主线是智谱；若你走官方 Pro/Max，自行看 Authentication。
...
![](/images/blog/claude-code-mac-glm-2026-wechat-16.png)  
npx coding-helper
...
![](/images/blog/claude-code-mac-glm-2026-wechat-17.png)  
cd 与 claude
...
![](/images/blog/claude-code-mac-glm-2026-wechat-18.png)  
危险模式命令
...
![](/images/blog/claude-code-mac-glm-2026-wechat-19.png)  
claude mcp add 示例
