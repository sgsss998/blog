...
把 Mac Mini 从箱子里拿出来、接上线、第一次开机的那天晚上，我坐在客厅里，看着它安静地亮起灯，心里想的是「以后你就替我守家了」。部署 OpenClaw 的过程其实挺折腾的，依赖一堆，环境变量要配，Ollama 要先拉好模型，有一回还因为端口被占用卡了半天，我对着报错搜了半天才发现是上次测试没关掉的进程。等终于看到 OpenClaw 在 Mini 上正常响应指令的时候，我下意识地看了一眼窗外的天色，已经快凌晨了，但当时一点都不困，反而有一种「地基打好了」的踏实感。
